...
describe('Database Security', () => {
  ...
  describe('validateBusinessAccess', () => {
    it('should validate legitimate business access', async () => {
      ...
      const isValid = await validateBusinessAccess(
        'business-123',
        'user-456',
        mockSupabase as any
      );
  ...
  describe('validateWhatsAppJID', () => {
    ...
    it('should handle edge cases', () => {
      ...
      expect(validateWhatsAppJID(null as any)).toBe(false);
      expect(validateWhatsAppJID(undefined as any)).toBe(false);
    });
  });
  ...
  describe('validateConversationAccess', () => {
    it('should validate conversation access for business owner', async () => {
      ...
      const isValid = await validateConversationAccess(
        'conv-123',
        'business-456',
        mockSupabase as any
      );
  ...
  describe('validateAssistantAccess', () => {
    it('should validate assistant access for business owner', async () => {
      ...
      const isValid = await validateAssistantAccess(
        'assistant-123',
        'business-456',
        mockSupabase as any
      );
  ...
  describe('extractBusinessIdFromContext', () => {
    it('should extract business ID from authorization header', () => {
      ...
      const businessId = extractBusinessIdFromContext(mockRequest as any);
