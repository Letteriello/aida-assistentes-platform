...
describe('EmbeddingService', () => {
    ...
    describe('generateEmbedding', () => {
        ...
        it('should handle API errors gracefully', async () => {
            ...
            await expect(embeddingService.generateEmbedding('Hello world!')).rejects.toThrow('Failed to generate embedding: Rate limit exceeded');
        });
        ...
        it('should handle text that exceeds token limit', async () => {
            ...
            await expect(embeddingService.generateEmbedding(longText)).rejects.toThrow('Text exceeds maximum token limit');
        });
    ...
    describe('queueEmbeddingRequest', () => {
        it('should queue embedding request for async processing', async () => {
            ...
            await expect(embeddingService.queueEmbeddingRequest(request)).resolves.not.toThrow();
        });
        it('should validate queue request format', async () => {
            ...
            await expect(embeddingService.queueEmbeddingRequest(invalidRequest)).rejects.toThrow('Invalid queue request');
        });
    });
    describe('getStats', () => {
    ...
    describe('rate limiting', () => {
        it('should respect rate limits', async () => {
            ...
            await expect(limitedService.generateEmbedding('Hello again!')).rejects.toThrow('Rate limit exceeded');
        });
    });
