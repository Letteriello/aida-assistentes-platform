...
import { createHybridQueryEngine, HybridQueryEngine } from '../../../rag/hybrid-query-engine';
import { testHelpers } from '../../setup';
describe('HybridQueryEngine', () => {
    let hybridQueryEngine;
    let mockVectorSearchEngine;
    ...
    describe('search', () => {
        it('should perform hybrid search combining vector, text, and graph results', async () => {
            ...
            expect(mockVectorSearchEngine.search).toHaveBeenCalledWith(expect.objectContaining({
                query: query.text,
        ...
        it('should handle search context and filters', async () => {
            ...
            expect(mockVectorSearchEngine.search).toHaveBeenCalledWith(expect.objectContaining({
                business_id: query.businessId
            }), expect.any(Array), expect.objectContaining({
    ...
    describe('searchKnowledgeGraph', () => {
        it('should search knowledge graph with relationships', async () => {
            ...
            expect(mockSupabase.rpc).toHaveBeenCalledWith('search_knowledge_graph', expect.objectContaining({
    ...
    describe('combineAndRankResults', () => {
        it('should combine results from different sources and rank by combined score', () => {
            ...
            const combinedResults = hybridQueryEngine.combineAndRankResults(vectorResults, textResults, graphResults);
        ...
        it('should remove duplicate results', () => {
            ...
            const combinedResults = hybridQueryEngine.combineAndRankResults(vectorResults, textResults, []);
