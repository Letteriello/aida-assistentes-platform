...
describe('AIResponseGenerator', () => {
    ...
    let mockLangChainProcessor;
    let mockHybridQueryEngine;
    ...
    describe('generateResponse', () => {
        ...
        it('should handle timeout scenarios', async () => {
            ...
            mockSupabase.from.mockReturnValue({
                select: vi.fn().mockReturnValue({
                    eq: vi.fn().mockReturnValue({
                        single: vi.fn().mockImplementation(() => new Promise(resolve => setTimeout(resolve, 200)))
                    })
                })
            });
    ...
    describe('processMessageQueue', () => {
        ...
        it('should prioritize high-priority messages', async () => {
            ...
            vi.spyOn(responseGenerator, 'generateResponse').mockImplementation(async (request) => {
