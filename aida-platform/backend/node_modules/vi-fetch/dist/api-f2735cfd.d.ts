...
interface FetchSpyInstance {
    ...
    willDo(fn: (url: URL, ...args: FetchArgs) => Promise<MockValue> | MockValue): FetchSpyInstance;
    clear(): void;
}
declare class FetchMockInstance implements FetchSpyInstance {
    ...
    getRoute(): string | RegExp;
    getMethod(): "GET" | "POST" | "PATCH" | "PUT" | "DELETE" | "HEAD";
    get spy(): SpyImpl<FetchArgs, Promise<Response>>;
    get baseUrl(): string;
    getRouteCalls(): FetchArgs[];
    getRouteResponses(): ResponseMock[];
    getRouteResults<T = unknown>(): T[];
...
declare const methods: readonly ["GET", "POST", "PATCH", "PUT", "DELETE", "HEAD"];
...
declare class MockStorage {
    ...
    clear(fetchMethod: Method, fetchUrl: string | RegExp, removeOnce?: boolean): this;
    clearAll(): this;
}
...
declare const mockHead: FetchSpyFnShort;
declare function createMockFetch({ baseUrl, global, fetchKey, }?: Partial<MockOptions>): {
    ...
    mockHead: FetchSpyFnShort;
};

export { AwaitedMockValue as A, FetchSpyInstance as F, HeadersMockInit as H, Method as M, mockDelete as a, mockGet as b, mockPatch as c, mockPost as d, mockPut as e, createMockFetch as f, FetchArgs as g, FetchMockInstance as h, MockValue as i, Mocks as j, mockHead as k, mockFetch as m, prepareFetch as p };
